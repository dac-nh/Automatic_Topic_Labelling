...
(function (R, N) {
    ...
    var N = function () {
        var a = R.document, A = R.navigator && R.navigator.userAgent || "",
            B = a && a.createElementNS && !!a.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            G = /(edge|msie|trident)/i.test(A) && !R.opera, F = /Firefox/.test(A),
    ...
    (function (a) {
        var A = [], B = a.charts, G = a.doc, F = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], f = this.paths[1], h = [], m = this.now, r = a.length, v;
                if (1 === m) h = this.toD; else if (r === f.length && 1 > m) for (; r--;) v = parseFloat(a[r]), h[r] = isNaN(v) ? a[r] : m * parseFloat(f[r] - v) + v; else h = f;
                this.elem.attr("d", h, null, !0)
            }, update: function () {
                var a = this.elem, f = this.prop, h = this.now, m = this.options.step;
                if (this[f + "Setter"]) this[f +
                "Setter"](); else a.attr ? a.element && a.attr(f, h, null, !0) : a.style[f] = h + this.unit;
                m && m.call(a, h, this)
            }, run: function (a, f, h) {
                ...
                var f = +new Date, h, m = this.options, r = this.elem, v = m.complete, d = m.duration, e = m.curAnim;
                ...
                f = f || "";
                var d, e = l.startX, n = l.endX, b = -1 < f.indexOf("C"), c = b ? 7 : 3, w, k, p;
                f =
                    f.split(" ");
                h = h.slice();
                var C = l.isArea, I = C ? 2 : 1, y;
                b && (m(f), m(h));
                if (e && n) {
                    for (p = 0; p < e.length; p++) if (e[p] === n[0]) {
                        d = p;
                        break
        ...
        a.merge = function () {
            var l, f = arguments, h, m = {}, r = function (f, d) {
                "object" !== typeof f && (f = {});
        ...
        a.pick = function () {
            var a = arguments, f, h, m = a.length;
            for (f = 0; f < m; f++) if (h = a[f], void 0 !== h && null !== h) return h
        };
        a.css = function (l, f) {
        ...
        a.createElement = function (l, f, h, m, r) {
            ...
            var v = a.css;
            f && a.extend(l, f);
            r && v(l, {padding: 0, border: "none", margin: 0});
            h && v(l, h);
            m && m.appendChild(l);
            return l
        };
        ...
        a.wrap =
            function (a, f, h) {
                var m = a[f];
                a[f] = function () {
                    var a = Array.prototype.slice.call(arguments), f = arguments, d = this;
                    d.proceed = function () {
        ...
        a.dateFormat = function (l, f, h) {
            ...
            var m = a.Date, r = new m(f -
                a.getTZOffset(f)), v = r[m.hcGetHours](), d = r[m.hcGetDay](), e = r[m.hcGetDate](),
                n = r[m.hcGetMonth](), b = r[m.hcGetFullYear](), c = a.defaultOptions.lang, w = c.weekdays,
                k = c.shortWeekdays, p = a.pad, m = a.extend({
        ...
        a.formatSingle = function (l, f) {
            var h = /\.([0-9])/, m = a.defaultOptions.lang;
        ...
        a.numberFormat = function (l, f, h, m) {
            l = +l || 0;
            f = +f;
            var r = a.defaultOptions.lang, v = (l.toString().split(".")[1] || "").split("e")[0].length, d, e,
                n = l.toString().split("e");
        ...
        a.find = Array.prototype.find ? function (a, f) {
            ...
            var h, m = a.length;
            for (h = 0; h < m; h++) if (f(a[h], h)) return a[h]
        };
        a.map = function (a, f) {
        ...
        a.addEvent = function (l, f, h) {
            var m = l.hcEvents = l.hcEvents || {}, r = l.addEventListener ||
        ...
        a.removeEvent = function (l, f, h) {
            ...
            function r() {
                ...
                l.nodeName && (f ? (e = {}, e[f] = !0) : e = d, a.objectEach(e, function (a, e) {
                    if (d[e]) for (b = d[e].length; b--;) m(e, d[e][b])
                }))
            }

            var v, d = l.hcEvents, e;
        ...
        a.fireEvent = function (l, f, h, m) {
            ...
            var v, d;
            h = h || {};
            if (G.createEvent && (l.dispatchEvent || l.fireEvent)) r = G.createEvent("Events"), r.initEvent(f, !0, !0), a.extend(r, h), l.dispatchEvent ? l.dispatchEvent(r) : l.fireEvent(f, r); else if (r) for (r = r[f] || [], v = r.length, h.target || a.extend(h, {
        ...
        a.animate = function (l, f, h) {
            var m, r = "", v, d, e;
            a.isObject(h) || (e =
                arguments, h = {duration: e[2], easing: e[3], complete: e[4]});
        ...
        a.seriesType = function (l,
                                 f, h, m, r) {
            var v = a.getOptions(), d = a.seriesTypes;
            v.plotOptions[l] = a.merge(v.plotOptions[f], h);
            d[l] = a.extendClass(d[f] || function () {
            }, m);
    ...
    (function (a) {
        var A = a.each, B = a.isNumber, G = a.map, F = a.merge, l = a.pInt;
        a.Color = function (f) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                }); else if (f && f.charAt && "#" === f.charAt() && (h = f.length, f = parseInt(f.substr(1), 16), 7 === h ? m = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1] : 4 === h && (m = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >> 4 | f & 240, (f & 15) << 4 | f & 15, 1])), !m) for (r = this.parsers.length; r-- && !m;) v = this.parsers[r],
                (h = v.regex.exec(f)) && (m = v.parse(h));
                this.rgba = m || []
            }, get: function (a) {
                var f = this.input, m = this.rgba, r;
                ...
                if (this.stops) A(this.stops, function (f) {
                    f.brighten(a)
                }); else if (B(a) && 0 !== a) for (f = 0; 3 > f; f++) m[f] += l(255 * a), 0 > m[f] && (m[f] = 0), 255 < m[f] &&
                (m[f] = 255);
                return this
    ...
    (function (a) {
        var A, B, G = a.addEvent, F = a.animate, l = a.attr, f = a.charts, h = a.color, m = a.css,
            r = a.createElement, v = a.defined, d = a.deg2rad, e = a.destroyObjectProperties, n = a.doc, b = a.each,
            c = a.extend, w = a.erase, k = a.grep, p = a.hasTouch, C = a.inArray, I = a.isArray, y = a.isFirefox,
            K = a.isMS, q = a.isObject, z = a.isString, J = a.isWebKit, t = a.merge, D = a.noop, E = a.objectEach,
            H = a.pick, g = a.pInt, u = a.removeEvent, P = a.stop, M = a.svg, O = a.SVG_NS, L = a.symbolSizes,
            S = a.win;
        ...
        c(A.prototype, {
            ...
            colorGradient: function (x, g, u) {
                var c = this.renderer, k, Q, d, e, w, p, M, n, L, f, y = [], q;
                ...
                Q && (d = x[Q], w = c.gradients, M = x.stops, f = u.radialReference, I(d) && (x[Q] =
                    ...
                    }), "radialGradient" === Q && f && !v(d.gradientUnits) && (e = d, d = t(d, c.getRadialAttr(f, e), {gradientUnits: "userSpaceOnUse"})), E(d, function (a, x) {
                    "id" !== x && y.push(x, a)
                }), E(M, function (a) {
                    y.push(a)
            ...
            applyTextOutline: function (x) {
                var g = this.element, u, c, k, d, t;
                -1 !== x.indexOf("contrast") && (x = x.replace(/contrast/g, this.renderer.getContrast(g.style.fill)));
                x = x.split(" ");
                c = x[x.length - 1];
            ...
            attr: function (a, g, u, c) {
                var x, k = this.element, b, d = this, Q, t;
                "string" === typeof a &&
            ...
            addClass: function (a, g) {
                ...
                -1 === x.indexOf(a) && (g || (a = (x + (x ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                var x = this.styles, u = {}, k = this.element, b, d = "", t, e = !x,
            ...
            updateTransform: function () {
                var a =
                    this.translateX || 0, g = this.translateY || 0, u = this.scaleX, c = this.scaleY, k = this.inverted,
                    b = this.rotation, d = this.matrix, t = this.element;
            ...
            getBBox: function (a, g) {
                var x, u = this.renderer, k, t = this.element, e = this.styles, Q, p = this.textStr, w, M = u.cache,
                    n = u.cacheKeys, L;
                g = H(g, this.rotation);
                k = g * d;
                Q = e && e.fontSize;
            ...
            add: function (a) {
                var g = this.renderer, x = this.element, u;
            ...
            destroy: function () {
                var a = this, g = a.element || {}, u = a.renderer.isSVG && "SPAN" === g.nodeName && a.parentGroup,
                    c = g.ownerSVGElement;
            ...
            shadow: function (a, g, u) {
                var x = [], c, k, b = this.element, d, t, e, p;
            ...
            zIndexSetter: function (a, u) {
                var c = this.renderer, k = this.parentGroup, x = (k || c).element || c.box, b, d = this.element, t, e,
                    c = x === c.box;
                b = this.added;
                var p;
                ...
                if (b) {
                    ...
                    u = x.childNodes;
                    for (p = u.length - 1; 0 <= p && !t; p--) if (k = u[p], b = k.zIndex, e = !v(b), k !== d) if (0 > a && e && !c && !p) x.insertBefore(d, u[p]), t = !0; else if (g(b) <= a || e &&
        ...
        c(B.prototype, {
            Element: A, SVG_NS: O, init: function (a, g, u, c, k, b) {
                var x;
                ...
                x = c.element;
                a.appendChild(x);
                -1 === a.innerHTML.indexOf("xmlns") && l(x, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = x;
                this.boxWrapper = c;
                this.alignedObjects = [];
                ...
                y && a.getBoundingClientRect && (g = function () {
                    ...
                    m(a, {left: Math.ceil(d.left) - d.left + "px", top: Math.ceil(d.top) - d.top + "px"})
            ...
            isHidden: function () {
                ...
                var k = a.rotation, b = u, x, d = 0, t = u.length, e = function (a) {
                ...
                var u = a.element, c = this, d = c.forExport, x = H(a.textStr, "").toString(),
                    t = -1 !== x.indexOf("\x3c"), e = u.childNodes, p, w, L, f, y = l(u, "x"), q = a.styles,
                    D = a.textWidth, C = q && q.lineHeight, z = q && q.textOutline,
                    h = q && "ellipsis" === q.textOverflow, I = q && "nowrap" === q.whiteSpace, P = q && q.fontSize, r,
                    v, K = e.length, q = D && !a.added && this.box, S = function (a) {
                        var k;
                ...
                if (r !== a.textCache) {
                    ...
                    t || z || h || D || -1 !== x.indexOf(" ") ? (p = /<.*class="([^"]+)".*>/, w = /<.*style="([^"]+)".*>/, L = /<.*href="([^"]+)".*>/, q && q.appendChild(u), x = t ? x.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g,
                        ...
                        b(x, function (g) {
                            if ("" !== g || 1 === x.length) {
                                var b = {}, e = n.createElementNS(c.SVG_NS, "tspan"), q, E;
                                ...
                                L.test(g) && !d && (l(e, "onclick", 'location.href\x3d"' + g.match(L)[1] +
                                    '"'), l(e, "class", "highcharts-anchor"), m(e, {cursor: "pointer"}));
                                ...
                                if (" " !== g) {
                                    ...
                                    l(e, b);
                                    u.appendChild(e);
                                    !t && v && (!M && d && m(e, {display: "block"}), l(e, "dy", S(e)));
                                    if (D) {
                                        b = g.replace(/([^\^])-/g, "$1- ").split(" ");
                                        q = 1 < x.length || k || 1 < b.length && !I;
                                        var C = [], Q, z = S(e), r = a.rotation;
                ...
                var x = this.label(a, g, u, w, null, null, null, null, "button"), M = 0;
                x.attr(t({padding: 8, r: 2}, b));
                var n, L, f, q;
                b = t({
                    fill: "#f7f7f7",
                    stroke: "#cccccc",
                ...
                L = d.style;
                delete d.style;
                e = t(b, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, e);
                f = e.style;
                delete e.style;
                p = t(b, {style: {color: "#cccccc"}}, p);
                q = p.style;
                delete p.style;
                ...
                x.attr(b).css(c({cursor: "default"}, n));
                ...
                q(a) ? (c = a, g = c.y, u = c.r, a = c.x) : c = {innerR: c, start: b, end: k};
                ...
                a = q(a) ? a : void 0 === a ? {} : {x: a, y: g, width: Math.max(u, 0), height: Math.max(c, 0)};
                ...
                var c = this.alignedObjects, b = c.length;
                this.width = a;
                this.height = g;
                ...
                1 < arguments.length && c(d, {x: g, y: u, width: b, height: k});
                ...
                var e = this, x, p = /^url\((.*?)\)$/, w = p.test(a), M = !w && (this.symbols[a] ?
                    a : "circle"), q = M && this.symbols[M],
                    y = v(g) && q && q.call(this.symbols, Math.round(g), Math.round(u), k, d, t), E, D;
                q ? (x = this.path(y), x.attr("fill", "none"), c(x, {
                    ...
                    x[a + "Setter"] = function (a, g) {
                        var u = {}, c = this["img" + g], b = "width" === g ? "translateX" : "translateY";
                        this[g] = a;
                    ...
                    x: g,
                    y: u
                }), x.isImg = !0, v(x.imgwidth) && v(x.imgheight) ? D() : (x.attr({width: 0, height: 0}), r("img", {
                    onload: function () {
                        var a = f[e.chartIndex];
                        0 === this.width && (m(this, {position: "absolute", top: "-999em"}), n.body.appendChild(this));
                ...
                circle: function (a, g, u, c) {
                    return this.arc(a + u / 2, g + c / 2, u / 2, c / 2, {start: 0, end: 2 * Math.PI, open: !1})
                    ...
                    return ["M", a + u / 2, g, "L", a + u, g + c / 2, a + u / 2, g + c, a, g + c / 2, "Z"]
                                  ...
                                  g, u, c, b) {
                    var k = b.start, d = b.r || u, t = b.r || c || u, e = b.end - .001;
                    u = b.innerR;
                    c = H(b.open, .001 > Math.abs(b.end - b.start - 2 * Math.PI));
                    var x = Math.cos(k), p = Math.sin(k), w = Math.cos(e), e = Math.sin(e);
                    ...
                    var k = Math.min(b && b.r || 0, u, c), d = k + 6, t = b && b.anchorX;
                    b = b && b.anchorY;
                    var e;
                    ...
                    return e
                                   ...
                                   b) {
                var k = a.uniqueKey(), d = this.createElement("clipPath").attr({id: k}).add(this.defs);
                ...
                c || (a.xSetter = function (a, g, u) {
                    var c = u.getElementsByTagName("tspan"), b, k = u.getAttribute(g), d;
                ...
                return {h: u, b: Math.round(.8 * u), f: a}
            }, rotCorr: function (a, g, u) {
                var c = a;
                g && u && (c = Math.max(c * Math.cos(g * d), 4));
                return {x: -a / 3 * Math.sin(g * d), y: c}
            }, label: function (g, k, d, e, p, w, M, n, L) {
                var x = this, q = x.g("button" !== L && "label"), f = q.text = x.text("", 0, 0, M).attr({zIndex: 1}),
                    y, E, D = 0, m = 3, C = 0, z, h, r, I, P, l = {}, K, S, H = /^url\((.*?)\)$/.test(e), O = H, Q, J,
                    U, T;
                ...
                U = function () {
                    var a = C + m, g;
                    g = n ? 0 : S;
                    v(z) && E && ("center" === P || "right" === P) && (a += {center: .5, right: 1}[P] * (z - E.width));
                ...
                q.onAdd = function () {
                    f.add(q);
                    q.attr({text: g || 0 === g ? g : "", x: k, y: d});
                    y && v(p) && q.attr({anchorX: p, anchorY: w})
                };
                ...
                return c(q, {
                    css: function (a) {
                        ...
                        return {width: E.width + 2 * m, height: E.height + 2 * m, x: E.x - m, y: E.y - m}
                    }, shadow: function (a) {
                        a &&
                        (J(), y && y.shadow(a));
                        return q
    ...
    (function (a) {
        var A = a.attr, B = a.createElement, G = a.css, F = a.defined, l = a.each, f = a.extend, h = a.isFirefox,
            m = a.isMS, r = a.isWebKit, v = a.pInt, d = a.SVGRenderer, e = a.win, n = a.wrap;
        f(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, c = this.element, d = this.translateX || 0, k = this.translateY || 0,
                        e = this.x || 0, n = this.y || 0, f = this.textAlign || "left",
                        y = {left: 0, center: .5, right: 1}[f], m = this.styles;
                    G(c,
                        {marginLeft: d, marginTop: k});
                    this.shadows && l(this.shadows, function (a) {
                        G(a, {marginLeft: d + 1, marginTop: k + 1})
                    });
                    this.inverted && l(c.childNodes, function (b) {
                        a.invertChild(b, c)
                    });
                    if ("SPAN" === c.tagName) {
                        var q = this.rotation, z = v(this.textWidth), h = m && m.whiteSpace,
                        ...
                        G(c, {left: e + (this.xCorr || 0) + "px", top: n + (this.yCorr || 0) + "px"});
                        r && (m = c.offsetHeight);
                        this.cTT = t
                    }
        ...
        f(d.prototype, {
            getTransformKey: function () {
                ...
                var b = this.createElement("span"), e = b.element, w = b.renderer, m = w.isSVG, y = function (a, c) {
                ...
                b.attr({text: a, x: Math.round(c), y: Math.round(d)}).css({
                            ...
                            l(d.reverse(), function (a) {
                                ...
                                f(a, {
                                    classSetter: function (a) {
                                        ...
                                        d[0].div && b.on.apply({element: d[0].div}, arguments);
                                        return a
                                    }, translateXSetter: t, translateYSetter: t
                                });
                                y(a, e)
                            })
                        }
    ...
    (function (a) {
        function A() {
            var f = a.defaultOptions.global, r = h.moment;
            if (f.timezone) {
        ...
        function B() {
            var m = a.defaultOptions.global, r, v = m.useUTC, d = v ? "getUTC" : "get", e = v ? "setUTC" : "set",
                n = "Minutes Hours Day Date Month FullYear".split(" "), b = n.concat(["Milliseconds", "Seconds"]);
        ...
        var G = a.color, F = a.getTZOffset, l = a.merge, f = a.pick, h = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        var A = a.correctFloat, B = a.defined, G = a.destroyObjectProperties, F = a.isNumber, l = a.merge, f = a.pick,
            h = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, h = a.options, v = a.chart, d = a.categories, e = a.names, n = this.pos,
                    b = h.labels, c = a.tickPositions, w = n === c[0], k = n === c[c.length - 1],
                    e = d ? f(d[n], e[n], n) : n, d = this.label, c = c.info, p;
                ...
                B(d) ? d && d.attr({text: h}) : (this.labelLength = (this.label = d = B(h) && b.enabled ? v.renderer.text(h, 0, 0, b.useHTML).css(l(b.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var m = this.axis, v = a.x, d = m.chart.chartWidth,
                    e = m.chart.spacing, n = f(m.labelLeft, Math.min(m.pos, e[3])),
                    e = f(m.labelRight, Math.max(m.pos + m.len, d - e[1])), b = this.label, c = this.rotation,
                    w = {left: 0, center: .5, right: 1}[m.labelAlign], k = b.getBBox().width, p = m.getSlotWidth(),
                    C = p, I = 1, y, l = {};
                if (c) 0 > c && v - w * k < n ? y = Math.round(v / Math.cos(c * h) - n) : 0 < c && v + w * k > e && (y = Math.round((d - v) / Math.cos(c * h))); else if (d = v + (1 - w) * k, v - w * k < n ? C = a.x + C * (1 - w) - n : d > e && (C = e - a.x + C * w, I = -1), C = Math.min(p, C), C < p && "center" === m.labelAlign && (a.x += I * (p - C - w * (p - Math.min(k, C)))), k > C || m.autoRotation && (b.styles ||
                        {}).width) y = C;
                y && (l.width = y, (m.options.labels.style || {}).textOverflow || (l.textOverflow = "ellipsis"), b.css(l))
            }, getPosition: function (a, f, h, d) {
                var e = this.axis, n = e.chart, b = d && n.oldChartHeight || n.chartHeight;
                return {
                ...
                var w = this.axis, k = w.transA, p = w.reversed,
                    m = w.staggerLines, I = w.tickRotCorr || {x: 0, y: 0}, y = e.y;
                ...
                var d = this.axis, e = d.options, n = this.gridLine, b = {},
                    c = this.pos, w = this.type, k = d.tickmarkOffset, p = d.chart.renderer,
                    m = w ? w + "Grid" : "grid", l = e[m + "LineWidth"], y = e[m + "LineColor"],
                    e = e[m + "LineDashStyle"];
                ...
                var d = this.axis, e = d.options, n = d.chart.renderer,
                    b = this.type, c = b ? b + "Tick" : "tick", w = d.tickSize(c), k = this.mark, p = !k, m = a.x;
                a = a.y;
                var I = f(e[c + "Width"], !b && d.isXAxis ? 1 : 0), e = e[c + "Color"];
                ...
                var e = this.axis, n = e.horiz, b = e.options, c = this.label, w = b.labels, k = w.step,
                    p = e.tickmarkOffset, m = !0,
                    I = a.x;
                a = a.y;
                ...
                var d = this.axis, e = d.horiz, n = this.getPosition(e, this.pos, d.tickmarkOffset, h), b = n.x,
                    c = n.y, d = e && b ===
    ...
    var W = function (a) {
        var A = a.addEvent, B = a.animObject, G = a.arrayMax, F = a.arrayMin, l = a.color, f = a.correctFloat,
            h = a.defaultOptions, m = a.defined, r = a.deg2rad, v = a.destroyObjectProperties, d = a.each, e = a.extend,
            n = a.fireEvent, b = a.format, c = a.getMagnitude, w = a.grep, k = a.inArray, p = a.isArray, C = a.isNumber,
            I = a.isString, y = a.merge, K = a.normalizeTickInterval,
            q = a.objectEach, z = a.pick, J = a.removeEvent, t = a.splat, D = a.syncTimeout, E = a.Tick,
            H = function () {
                this.init.apply(this, arguments)
            };
        a.extend(H.prototype, {
            ...
            init: function (a, u) {
                ...
                u = c.options.events;
                -1 === k(c, a.axes) && (g ? a.axes.splice(a.xAxis.length,
            ...
            defaultLabelFormatter: function () {
                var g = this.axis, u = this.value, c = g.categories, d = this.dateTimeLabelFormat, k = h.lang,
                    e = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, t = e && e.length, p,
                    f = g.options.labels.format, g = g.isLog ? Math.abs(u) : g.tickInterval;
                if (f) p = b(f, this); else if (c) p = u; else if (d) p = a.dateFormat(d, u); else if (t && 1E3 <= g) for (; t-- && void 0 === p;) c = Math.pow(k, t + 1), g >= c && 0 === 10 * u % c && null !== e[t] && 0 !== u && (p = a.numberFormat(u / c, -1) + e[t]);
                void 0 === p && (p = 1E4 <= Math.abs(u) ? a.numberFormat(u, -1) : a.numberFormat(u,
                    -1, void 0, ""));
                return p
            },
            getSeriesExtremes: function () {
                var a = this, u = a.chart;
                ...
                d(a.series, function (g) {
                    if (g.visible || !u.options.chart.ignoreHiddenSeries) {
                        var c = g.options, b = c.threshold, d;
                        ...
                        if (a.isXAxis) c = g.xData, c.length && (g = F(c), C(g) || g instanceof Date || (c = w(c, function (a) {
                            ...
                            g), a.dataMax = Math.max(z(a.dataMax, c[0]), G(c))); else if (g.getExtremes(), d = g.dataMax, g = g.dataMin, m(g) && m(d) && (a.dataMin = Math.min(z(a.dataMin, g), g), a.dataMax = Math.max(z(a.dataMax, d), d)), m(b) && (a.threshold = b), !c.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
                    }
                })
            },
            translate: function (a, c, b, d, k, e) {
                var g = this.linkedParent || this, u = 1, t = 0, p = d ? g.oldTransA : g.transA;
                d = d ? g.oldMin : g.min;
            ...
            getPlotLinePath: function (a, c, b, d, k) {
                var g = this.chart, u = this.left, t = this.top, e, p, f = b && g.oldChartHeight || g.chartHeight,
                    w = b && g.oldChartWidth || g.chartWidth, q;
                e = this.transB;
                var n = function (a,
                                  g, c) {
            ...
            getMinorTickPositions: function () {
                var a = this, c = a.options, b = a.tickPositions, k = a.minorTickInterval, e = [],
                    t = a.pointRangePadding || 0, p = a.min - t, t = a.max + t, f = t - p;
                if (f && f / k < a.len / 3) if (a.isLog) d(this.paddedTicks, function (g, c, u) {
                    ...
                    p, t, c.startOfWeek)); else for (c = p + (b[0] - p) % k; c <= t && c !== e[0]; c += k) e.push(c);
                0 !== e.length && a.trimTicks(e);
                return e
            },
            adjustForMinRange: function () {
                var a = this.options, c = this.min, b = this.max, k, e, t, p, f, w, q, n;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (m(a.min) || m(a.max) ? this.minRange = null : (d(this.series, function (a) {
                    w = a.xData;
                    for (p = q = a.xIncrement ? 1 : w.length - 1; 0 < p; p--) if (f = w[p] - w[p - 1], void 0 === t || f < t) t = f
            ...
            getClosest: function () {
                ...
                this.categories ? a = 1 : d(this.series, function (g) {
                    var c = g.closestPointRange, u = g.visible || !g.chart.options.chart.ignoreHiddenSeries;
            ...
            nameToX: function (a) {
                ...
                m(b) || (b = !1 === this.options.uniqueNames ? a.series.autoIncrement() : k(a.name, c));
            ...
            setAxisTranslation: function (a) {
                var g = this, c = g.max - g.min, b = g.axisPointRange || 0, k, e = 0, t = 0, p = g.linkedParent,
                    f = !!g.categories, w = g.transA, n = g.isXAxis;
            ...
            setTickInterval: function (g) {
                var b = this, k = b.chart, e = b.options, t = b.isLog, p = b.log2lin, w = b.isDatetimeAxis,
                    q = b.isXAxis, y = b.isLinked, E = e.maxPadding, D = e.minPadding, h = e.tickInterval,
                    l = e.tickPixelInterval,
                    I = b.categories, H = b.threshold, r = b.softThreshold, v, J, A, B;
            ...
            setTickPositions: function () {
                ...
                var k = a.tickPositioner, d = a.startOnTick, e = a.endOnTick;
            ...
            trimTicks: function (a, b, c) {
                var g = a[0], k = a[a.length - 1], d = this.minPointOffset || 0;
                if (!this.isLinked) {
                    if (b && -Infinity !== g) this.min = g; else for (; this.min - d > a[0];) a.shift();
                    if (c) this.max = k; else for (; this.max + d < a[a.length - 1];) a.pop();
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || d(this.chart[this.coll], function (g) {
                    var c =
                        g.options, c = [g.horiz ? c.left : c.top, c.width, c.height, c.pane].join();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount, k = this.finalTickAmt,
                    d = b && b.length;
                if (d < c) {
            ...
            setScale: function () {
                ...
                d(this.series, function (g) {
                    if (g.isDirtyData || g.isDirty || g.xAxis.isDirty) a =
                        !0
                });
            ...
            zoom: function (a, b) {
                var g = this.dataMin, c = this.dataMax, k = this.options, d = Math.min(g, z(k.min, g)),
                    k = Math.max(c, z(k.max, c));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (m(g) && (a < d && (a = d), a > k && (a = k)), m(c) && (b < d && (b = d), b > k && (b = k))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var b = this.chart, c = this.options, k = c.offsets ||
                    [0, 0, 0, 0], d = this.horiz,
            ...
            getThreshold: function (a) {
                var b = this.isLog, c = this.lin2log, g = b ? c(this.min) : this.min, b = b ? c(this.max) : this.max;
            ...
            tickSize: function (a) {
                var b = this.options,
                    c = b[a + "Length"], g = z(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz, c = this.tickInterval, k = c,
                    e = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), t, p = a.rotation,
                    f = this.labelMetrics(),
                    w, n = Number.MAX_VALUE, q, y = function (a) {
                        a /= e || 1;
                        a = 1 < a ? Math.ceil(a) : 1;
                        return a * c
                    };
            ...
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, c = this.tickPositions, k = this.ticks, e = this.options.labels,
                    t = this.horiz, p = this.getSlotWidth(), f = Math.max(1, Math.round(p - 2 * (e.padding || 5))),
                    w = {}, n = this.labelMetrics(), q = e.style && e.style.textOverflow, E, D = 0, h, m;
                ...
                if (this.autoRotation) D > f && D > n.h ? w.rotation = this.labelRotation : this.labelRotation = 0; else if (p && (E = {width: f + "px"}, !q)) for (E.textOverflow = "clip", h = c.length; !t && h--;) if (m = c[h], f = k[m].label) f.styles && "ellipsis" === f.styles.textOverflow ? f.css({textOverflow: "clip"}) : k[m].labelLength > p && f.css({width: p + "px"}), f.getBBox().height > this.len / c.length - (n.h - n.f) && (f.specCss = {textOverflow: "ellipsis"});
                w.rotation && (E = {
            ...
            addTitle: function (a) {
                var b = this.chart.renderer, c = this.horiz, g = this.opposite, k = this.options.title,
                    d;
                ...
                k.style.width || this.isRadial || this.axisTitle.css({width: this.len});
            ...
            getOffset: function () {
                var a = this, b = a.chart, c = b.renderer, k = a.options, e = a.tickPositions, t = a.ticks, p = a.horiz,
                    f = a.side, w = b.inverted && !a.isZAxis ? [1, 0, 3, 2][f] : f, n, y, E = 0, D, h = 0, C = k.title,
                    l = k.labels, I = 0, H = b.axisOffset, b = b.clipOffset, r = [-1, 1, 1, -1][f], v = k.className,
                    K = a.axisParent, J = this.tickSize("tick");
                n = a.hasData();
                a.showAxis = y = n || z(k.showEmpty, !0);
                a.staggerLines = a.horiz && l.staggerLines;
                a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: k.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() +
                    "-grid " + (v || "")).add(K), a.axisGroup = c.g("axis").attr({zIndex: k.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(K), a.labelGroup = c.g("axis-labels").attr({zIndex: l.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (v || "")).add(K));
            ...
            getLinePath: function (a) {
                var b = this.chart, c = this.opposite, g = this.offset, k = this.horiz,
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top, k = this.len, d = this.options.title, e = a ? b : c,
                    t = this.opposite, p = this.offset, f = d.x || 0, w = d.y || 0, n = this.axisTitle,
                    q = this.chart.renderer.fontMetrics(d.style && d.style.fontSize, n),
                    n = Math.max(n.getBBox(null, 0).height - q.h - 1, 0),
                    k = {low: e + (a ? 0 : k), middle: e + k / 2, high: e + (a ? k : 0)}[d.align],
            ...
            renderMinorTick: function (a) {
                var b = this.chart.hasRendered && C(this.oldMin), c = this.minorTicks;
                c[a] || (c[a] = new E(this, a, "minor"));
                b && c[a].isNew && c[a].render(null, !0);
                c[a].render(null, !1, 1)
            },
            renderTick: function (a, b) {
                var c = this.isLinked, g = this.ticks, k = this.chart.hasRendered && C(this.oldMin);
                if (!c || a >= this.min && a <= this.max) g[a] || (g[a] = new E(this, a)), k && g[a].isNew && g[a].render(b, !0, .1), g[a].render(b)
            },
            render: function () {
                var b =
                        this, c = b.chart, k = b.options, e = b.isLog, t = b.lin2log, p = b.isLinked, f = b.tickPositions,
                    w = b.axisTitle, n = b.ticks, y = b.minorTicks, h = b.alternateBands, m = k.stackLabels,
                    l = k.alternateGridColor, z = b.tickmarkOffset, I = b.axisLine, H = b.showAxis,
                    r = B(c.renderer.globalAnimation), v, K;
                ...
                I && (I[I.isPlaced ? "animate" : "attr"]({d: this.getLinePath(I.strokeWidth())}), I.isPlaced = !0, I[H ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var b = this, c = b.stacks, g = b.plotLinesAndBands, e;
                a || J(b);
                q(c, function (a, b) {
                    v(a);
                    c[b] = null
            ...
            drawCrosshair: function (a, b) {
                var c, g = this.crosshair, k = z(g.snap, !0), d, e = this.cross;
                ...
                this.crosshair && !1 !== (m(b) || !k) ? (k ? m(b) && (d = this.isXAxis ? b.plotX : this.len - b.plotY) : d = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), m(d) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : z(b.stackY, b.y)), null, null, null, d) || null), m(c) ? (b = this.categories && !this.isRadial, e || (this.cross =
                    e = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + g.className).attr({zIndex: z(g.zIndex, 2)}).add(), e.attr({
                    stroke: g.color || (b ? l("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
                    "stroke-width": z(g.width, 1)
                }).css({"pointer-events": "none"}), g.dashStyle && e.attr({dashstyle: g.dashStyle})), e.show().attr({d: c}), b && !g.width && e.attr({"stroke-width": this.transA}), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair()
            },
    ...
    (function (a) {
        var A = a.Axis, B = a.Date, G = a.dateFormat, F = a.defaultOptions, l = a.defined, f = a.each, h = a.extend,
            m = a.getMagnitude, r = a.getTZOffset, v = a.normalizeTickInterval, d = a.pick, e = a.timeUnits;
        A.prototype.getTimeTicks = function (a, b, c, w) {
            var k = [], p = {}, n = F.global.useUTC, m, y = new B(b - Math.max(r(b), r(c))), v = B.hcMakeTime,
                q = a.unitRange, z = a.count, J, t;
            if (l(b)) {
                ...
                m = y[B.hcGetFullYear]();
                w = y[B.hcGetMonth]();
                var D = y[B.hcGetDate](), E = y[B.hcGetHours]();
    ...
    (function (a) {
        var A = a.Axis, B = a.getMagnitude, G = a.map, F = a.normalizeTickInterval, l = a.pick;
        A.prototype.getLogTickPositions = function (a, h, m, r) {
            var f = this.options, d = this.len, e = this.lin2log, n = this.log2lin, b = [];
            r || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), b = this.getLinearTickPositions(a, h, m); else if (.08 <= a) for (var d = Math.floor(h), c, w, k, p, C, f = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; d < m + 1 && !C; d++) for (w = f.length, c = 0; c < w && !C; c++) k = n(e(d) * f[c]), k > h && (!r || p <=
                m) && void 0 !== p && b.push(p), p > m && (C = !0), p = k; else h = e(h), m = e(m), a = r ? this.getMinorTickInterval() : f.tickInterval, a = l("auto" === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (r ? 5 : 1) * (m - h) / ((r ? d / this.tickPositions.length : d) || 1)), a = F(a, null, B(a)), b = G(this.getLinearTickPositions(a, h, m), n), r || (this._minorAutoInterval = a / 5);
    ...
    (function (a, A) {
        var B = a.arrayMax,
            G = a.arrayMin, F = a.defined, l = a.destroyObjectProperties, f = a.each, h = a.erase, m = a.merge,
            r = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var f = this, d = f.axis, e = d.horiz, n = f.options, b = n.label, c = f.label, w = n.to, k = n.from,
                    p = n.value, h = F(k) && F(w), l = F(p), y = f.svgElem, K = !y, q = [], z = n.color,
                    J = r(n.zIndex, 0), t = n.events,
                    q = {"class": "highcharts-plot-" + (h ? "band " : "line ") + (n.className || "")}, D = {},
                    E = d.chart.renderer, H = h ? "bands" : "lines", g = d.log2lin;
                ...
                if (l) q = d.getPlotLinePath(p, y.strokeWidth()); else if (h) q = d.getPlotBandPath(k, w, n); else return;
                K && q && q.length ? (y.attr({d: q}), t && a.objectEach(t, function (a,
                                                                                     b) {
                    y.on(b, function (a) {
                        t[b].apply(f, [a])
                    })
                })) : y && (q ? (y.show(), y.animate({d: q})) : (y.hide(), c && (f.label = c = c.destroy())));
                ...
                b || (b = {
                    align: a.textAlign || a.align, rotation: a.rotation, "class": "highcharts-plot-" + (e ? "band" :
                ...
                e = G(f);
                c = G(d);
                b.align(a, !1, {x: e, y: c, width: B(f) - e, height: B(d) - c});
                b.show()
            }, destroy: function () {
        ...
        a.extend(A.prototype, {
            getPlotBandPath: function (a, d) {
                var e = this.getPlotLinePath(d, null, null, !0), f = this.getPlotLinePath(a, null, null, !0),
                    b = this.horiz, c = 1;
                ...
                var e = (new a.PlotLineOrBand(this, f)).render(), n = this.userOptions;
    ...
    (function (a) {
        var A = a.dateFormat, B = a.each, G = a.extend, F = a.format, l = a.isNumber,
            f = a.map, h = a.merge, m = a.pick, r = a.splat, v = a.syncTimeout, d = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, d) {
                ...
                var b, c = this.chart, e = c.inverted, k = c.plotTop, p = c.plotLeft, n = 0, h = 0, y, m;
                a = r(a);
                b = a[0].tooltipPos;
                ...
                var c = this.chart, e = this.distance, k = {}, p = b.h || 0, f,
                    n = ["y", c.chartHeight, d, b.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
                    ...
                    q = function (a, b, c, g, d, t) {
                        var f = c < g - e, u = g + e + c < b, w = g - e - c;
                        g += e;
                        if (h && u) k[a] = g; else if (!h && f) k[a] = w; else if (f) k[a] = Math.min(t - c, 0 > w - p ? w : w - p); else if (u) k[a] = Math.max(d, g + p + c > b ? g : g + p); else return !1
                    }, l = function (a, b, c, g) {
                        var d;
                ...
                var b, c = this.options, e, k = a, p, f = {}, n = [];
                ...
                var b = this, c = [], e = this.chart, k = e.renderer, p = !0, n = this.options, h = 0,
                    y = this.getLabel();
                a.isString(d) && (d = [!1, d]);
                B(d.slice(0, f.length + 1), function (a, d) {
                    if (!1 !== a) {
                        d = f[d - 1] || {isHeader: !0, plotX: f[0].plotX};
                        var w = d.series || b, q = w.tt, t = d.series || {},
                        ...
                        c.push({
                            target: d.isHeader ? e.plotHeight +
                                h : a, rank: d.isHeader ? 1 : 0, size: w.tt.getBBox().height + 1, point: d, x: t, tt: q
                        })
                    }
                });
                this.cleanSplit();
                ...
                var d = this.chart, b = this.getLabel(), b = (this.options.positioner ||
                ...
                var e = A("%m-%d %H:%M:%S.%L", f), k, p, n = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3},
                    h = "millisecond";
                for (p in d) {
                ...
                d = d ? "footer" : "header";
                var b = a.series, c = b.tooltipOptions, e = c.xDateFormat, k = b.xAxis,
                    f = k && "datetime" === k.options.type && l(a.key), n = c[d + "Format"];
                f && !e && (e = this.getXDateFormat(a, c, k));
                f && e && B(a.point && a.point.tooltipDateKeys || ["key"], function (a) {
                    n = n.replace("{point." + a + "}", "{point." + a + ":" + e + "}")
                });
                return F(n, {point: a, series: b})
            },
    ...
    (function (a) {
        var A = a.addEvent, B = a.attr, G = a.charts, F = a.color, l = a.css, f = a.defined, h = a.each, m = a.extend,
            r = a.find, v = a.fireEvent, d = a.isObject, e = a.offset, n = a.pick, b = a.removeEvent, c = a.splat,
            w = a.Tooltip;
        ...
        a.Pointer.prototype = {
            init: function (a, b) {
                ...
                var b = this.chart, c = b.options.chart, d = c.zoomType || "", b = b.inverted;
                ...
                return m(a, {chartX: Math.round(c.pageX - b.left), chartY: Math.round(c.pageY - b.top)})
                ...
                h(a, function (a) {
                    ...
                    a = a.searchPoint(c, e);
                    if ((e = d(a,
                            !0)) && !(e = !d(k, !0))) var e = k.distX - a.distX, f = k.dist - a.dist,
                ...
                var c = a.series, d = c.xAxis, c = c.yAxis;
                if (d && c) return b ? {chartX: d.len + d.pos - a.clientX, chartY: c.len + c.pos - a.plotY} : {
                    chartX: a.clientX + d.pos, chartY: a.plotY +
                    c.pos
                }
            }, getHoverData: function (b, c, e, f, w, m, q) {
                var k, p = [], t = q && q.isBoosting;
                f = !(!f || !b);
                ...
                return {hoverPoint: k, hoverSeries: c, hoverPoints: p}
            }, runPointActions: function (b, c) {
                var d = this.chart, k = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    e = k ? k.shared : !1, f = c || d.hoverPoint, p = f && f.series || d.hoverSeries,
                    p = this.getHoverData(f, p, d.series, !!c || p && p.directTouch && this.isDirectTouch, e, b, {isBoosting: d.isBoosting}),
                    w, f = p.hoverPoint;
                w = p.hoverPoints;
                ...
                h(d.axes, function (c) {
                    var d = n(c.crosshair.snap, !0), k = d ? a.find(w, function (a) {
                        return a.series[c.coll] === c
                    }) : void 0;
                    k || !d ? c.drawCrosshair(b, k) : c.hideCrosshair()
                })
            }, reset: function (a, b) {
                var d = this.chart, k = d.hoverSeries, e = d.hoverPoint, f = d.hoverPoints, p = d.tooltip,
                    w = p && p.shared ? f : e;
                ...
                var b = this.chart, c = b.options.chart, d = a.chartX, k = a.chartY, e = this.zoomHor,
                    f = this.zoomVert, w = b.plotLeft, n = b.plotTop, t = b.plotWidth, h = b.plotHeight, E,
                    m = this.selectionMarker, g = this.mouseDownX, u = this.mouseDownY,
                ...
                if (this.selectionMarker) {
                    var k = {originalEvent: a, xAxis: [], yAxis: []}, e = this.selectionMarker,
                        w = e.attr ? e.attr("x") : e.x, n = e.attr ? e.attr("y") : e.y,
                        r = e.attr ? e.attr("width") : e.width, t = e.attr ? e.attr("height") : e.height, D;
                    if (this.hasDragged || d) h(c.axes, function (c) {
                        if (c.zoomEnabled && f(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var e = c.horiz, g = "touchend" === a.type ? c.minPixelPadding : 0,
                                p = c.toValue((e ? w : n) + g), e = c.toValue((e ? w + r : n + t) - g);
                            k[c.coll].push({
                                axis: c, min: Math.min(p,
                                    e), max: Math.max(p, e)
                            });
                            D = !0
                        }
                    }), D && v(c, "selection", k, function (a) {
                        c.zoom(m(a, d ? {animation: !1} : null))
                    });
                    this.selectionMarker = this.selectionMarker.destroy();
                    d && this.scaleGroups()
                }
                c && (l(c.container, {cursor: c._cursor}), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [])
            ...
            onDocumentMouseMove: function (a) {
                ...
                var b = this.chart, c = b.hoverPoint, d = b.plotLeft, k = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (v(c.series, "click", m(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (m(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - k) && v(b, "click", a)))
            }, setDOMEvents: function () {
                var b =
                    this, c = b.chart.container, d = c.ownerDocument;
    ...
    (function (a) {
        var A = a.charts, B = a.each, G = a.extend, F = a.map, l = a.noop, f = a.pick;
        G(a.Pointer.prototype, {
            pinchTranslate: function (a, f, l, v, d, e) {
                ...
                var c = this.chart, w = a ? "x" : "y", k = a ? "X" : "Y", p = "chart" + k, h = a ? "width" : "height",
                    m = c["plot" + (a ? "Left" : "Top")], y, r, q = b || 1, z = c.inverted, J = c.bounds[a ? "h" : "v"],
                    t = 1 === f.length, D = f[0][p], E = l[0][p], H = !t && f[1][p], g = !t && l[1][p], u;
                l = function () {
                ...
                var h = this, r = h.chart, v = h.pinchDown, d = a.touches, e = d.length, n = h.lastValidTouch,
                    b = h.hasZoom, c = h.selectionMarker, w = {},
                ...
                "touchstart" === a.type ? (B(d, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = r.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding,
                            d = a.toPixels(f(a.options.min, a.dataMin)), e = a.toPixels(f(a.options.max, a.dataMax)),
                            k = Math.max(d, e);
                ...
                var l = this.chart, v, d;
                if (l.index !== a.hoverChartIndex) this.onContainerMouseLeave({relatedTarget: !0});
                a.hoverChartIndex = l.index;
                1 === h.touches.length ? (h = this.normalize(h), (d = l.isInsidePlot(h.chartX - l.plotLeft, h.chartY - l.plotTop)) && !l.openMenu ? (m && this.runPointActions(h), "touchmove" === h.type && (m = this.pinchDown, v = m[0] ? 4 <= Math.sqrt(Math.pow(m[0].chartX - h.chartX, 2) + Math.pow(m[0].chartY - h.chartY, 2)) : !1), f(v,
    ...
    (function (a) {
        var A = a.addEvent, B = a.charts, G = a.css, F = a.doc, l = a.extend, f = a.noop, h = a.Pointer,
            m = a.removeEvent, r = a.win, v = a.wrap;
        if (!a.hasTouch && (r.PointerEvent || r.MSPointerEvent)) {
            var d = {}, e = !!r.PointerEvent, n = function () {
                var b =
                    [];
                b.item = function (a) {
                    return this[a]
            ...
            v(h.prototype, "init", function (a, b, d) {
                a.call(this, b, d);
                this.hasZoom && G(b.container, {"-ms-touch-action": "none", "touch-action": "none"})
            });
    ...
    (function (a) {
        var A = a.addEvent, B = a.css, G = a.discardElement, F = a.defined, l = a.each, f = a.isFirefox,
            h = a.marginNames, m = a.merge,
            r = a.pick, v = a.setAnimation, d = a.stableSort, e = a.win, n = a.wrap;
        ...
        a.Legend.prototype = {
            init: function (a, c) {
                ...
                var b = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol,
                    n = this.itemHiddenStyle.color, b = c ? b.itemStyle.color : n, h = c ? a.color || n : n,
                    m = a.options && a.options.marker, q = {fill: h};
                d && d.css({
                    fill: b,
                    color: b
                });
                ...
                var b = this.options, d = b.symbolPadding, b = !b.rtl, e = a._legendItemPos, f = e[0], e = e[1],
                    n = a.checkbox;
                ...
                var b = this.group && this.group.alignAttr, d, e = this.clipHeight || this.legendHeight,
                    f = this.titleHeight;
            ...
            renderTitle: function () {
                ...
                d.text && (this.title || (this.title = this.chart.renderer.label(d.text, c - 3, c - 4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}).css(d.style).add(this.group)), a = this.title.getBBox(), e = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: e}));
                this.titleHeight = e
            }, setText: function (b) {
                var c = this.options;
                ...
                var b =
                        this.chart, d = b.renderer, e = this.options, f = "horizontal" === e.layout, n = this.symbolWidth,
                    h = e.symbolPadding, l = this.itemStyle, v = this.itemHiddenStyle, q = this.padding,
                    z = f ? r(e.itemDistance, 20) : 0, J = !e.rtl, t = e.width, D = e.itemMarginBottom || 0,
                    E = this.itemMarginTop, H = a.legendItem, g = !a.series,
                    u = !g && a.series.drawLegendSymbol ? a.series : a, P = u.options,
                    M = this.createCheckboxForItem && P && P.showCheckbox, P = n + h + z + (M ? 20 : 0), O = e.useHTML,
                    L = a.options.className;
                H || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" +
                    a.colorIndex + (L ? " " + L : "") + (g ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = H = d.text("", J ? n + h : -h, this.baseline || 0, O).css(m(a.visible ? l : v)).attr({
                    align: J ? "left" : "right",
                    zIndex: 2
                ...
                l.width || H.css({width: (e.itemWidth || e.width || b.spacingBox.width) - P});
                this.setText(a);
                d = H.getBBox();
                ...
                var b = this.chart, d = this.options, e = d.align.charAt(0) + d.verticalAlign.charAt(0) +
                    d.layout.charAt(0);
                ...
                var a = this, c = a.chart, e = c.renderer, k = a.group, f, n, h, y, r = a.box, q = a.options,
                    z = a.padding;
                a.itemX = z;
                a.itemY = a.initialItemY;
                a.offsetWidth = 0;
                a.lastItemY = 0;
                k || (a.group = k = e.g("legend").attr({zIndex: 7}).add(), a.contentGroup = e.g().attr({zIndex: 1}).add(k),
                ...
                y += z;
                r || (a.box = r = e.rect().addClass("highcharts-legend-box").attr({r: q.borderRadius}).add(k), r.isNew = !0);
                r.attr({
                ...
                n && k.align(m(q, {width: h, height: y}), !0, "spacingBox");
                c.isResizing || this.positionCheckboxes()
            }, handleOverflow: function (a) {
                var b = this, d = this.chart, e = d.renderer, f = this.options, n = f.y, h = this.padding,
                    d = d.spacingBox.height + ("top" === f.verticalAlign ?
                        -n : n) - h, n = f.maxHeight, m, v = this.clipRect, q = f.navigation, z = r(q.animation, !0),
                    J = q.arrowSize || 12, t = this.nav, D = this.pages, E, H = this.allItems, g = function (a) {
                        "number" === typeof a ? v.attr({height: a}) : v && (b.clipRect = v.destroy(), b.contentGroup.clip());
                ...
                a > d && !1 !== q.enabled ? (this.clipHeight = m = Math.max(d - 20 - this.titleHeight -
                    ...
                    c !== E && (E = c)
                }), v || (v = b.clipRect = e.clipRect(0, h, 9999, 0), b.contentGroup.clip(v)), g(m), t || (this.nav = t = e.g().attr({zIndex: 1}).add(this.group), this.up = e.symbol("triangle", 0, 0, J, J).on("click", function () {
                    b.scroll(-1, z)
                    ...
                    b.scroll(1, z)
                }).add(t)), b.scroll(0), a = d) : t && (g(), this.nav = t.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, c) {
                var b = this.pages, d = b.length;
                a = this.currentPage + a;
                var e = this.clipHeight, f = this.options.navigation, n = this.pager, h = this.padding;
                a > d && (a = d);
                0 < a && (void 0 !== c && v(c, this.chart), this.nav.attr({
                    translateX: h, translateY: e + this.padding +
                    7 + this.titleHeight, visibility: "visible"
                }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), n.attr({text: a + "/" + d}), this.down.attr({
                    x: 18 + this.pager.getBBox().width,
                    "class": a === d ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                }), this.up.attr({fill: 1 === a ? f.inactiveColor : f.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === d ? f.inactiveColor : f.activeColor}).css({cursor: a === d ? "default" : "pointer"}), c = -b[a - 1] + this.initialItemY,
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                ...
                c.legendSymbol = this.chart.renderer.rect(d ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, d ? b : a.symbolWidth, b, r(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(c.legendGroup)
            }, drawLineMarker: function (a) {
                var b = this.options, d = b.marker, e = a.symbolWidth, f = a.symbolHeight, n = f / 2,
                    h = this.chart.renderer, l =
                        this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                var v;
                v = {"stroke-width": b.lineWidth || 0};
    ...
    (function (a) {
        var A = a.addEvent, B = a.animate, G = a.animObject, F = a.attr, l = a.doc, f = a.Axis, h = a.createElement,
            m = a.defaultOptions, r = a.discardElement, v = a.charts, d = a.css, e = a.defined, n = a.each,
            b = a.extend, c = a.find, w = a.fireEvent, k = a.grep, p = a.isNumber, C = a.isObject, I = a.isString,
            y = a.Legend, K = a.marginNames, q = a.merge, z = a.objectEach, J = a.Pointer, t = a.pick, D = a.pInt,
            E = a.removeEvent, H = a.seriesTypes,
            g = a.splat, u = a.svg, P = a.syncTimeout, M = a.win, O = a.Chart = function () {
        ...
        b(O.prototype, {
            callbacks: [], getArgs: function () {
                ...
                var d, g, e = b.series, f = b.plotOptions || {};
                b.series = null;
                d = q(m, b);
                ...
                var d = this.axes, g = this.series, e = this.pointer, f = this.legend, k = this.isDirtyLegend, t, u,
                    h = this.hasCartesianSeries, p = this.isDirtyBox, q, E = this.renderer, m =
                        E.isHidden(), l = [];
                this.setResponsive && this.setResponsive(!1);
                a.setAnimation(c, this);
                m && this.temporaryDisplay();
                this.layOutTitles();
                for (c = g.length; c--;) if (q = g[c], q.options.stacking && (t = !0, q.isDirty)) {
                    u = !0;
                    break
                }
                if (u) for (c = g.length; c--;) q = g[c], q.options.stacking && (q.isDirty = !0);
                n(g, function (a) {
                ...
                var d = this, g = d.options, e;
                e = g.title = q({style: {color: "#333333", fontSize: g.isStock ? "16px" : "18px"}}, g.title, a);
                g = g.subtitle = q({style: {color: "#666666"}}, g.subtitle, b);
                n([["title", a, e], ["subtitle", b, g]], function (a, b) {
                    var c = a[0], g = d[c], e = a[1];
                    a = a[2];
                    g && e && (d[c] = g = g.destroy());
                ...
                var c = 0, d, g = this.renderer, e = this.spacingBox;
                n(["title", "subtitle"], function (a) {
                    var d = this[a], f = this.options[a];
                    a = "title" === a ? -3 : f.verticalAlign ? 0 : c + 2;
                    var k;
                    d && (k = f.style.fontSize, k = g.fontMetrics(k, d).b, d.css({width: (f.width || e.width + f.widthAdjust) + "px"}).align(b({y: a + k}, f), !1, "spacingBox"), f.floating || f.verticalAlign || (c = Math.ceil(c + d.getBBox(f.useHTML).height)))
                }, this);
                ...
                var c = this.renderTo;
                if (b) for (; c &&
                              c.style;) c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (l.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode; else for (; c && c.style;) {
                ...
                var c, d = this.options, g = d.chart, e, f;
                c = this.renderTo;
                var k = a.uniqueKey(), t;
                ...
                this.container = c = h("div", {id: k}, t, c);
                ...
                var c = this, d = c.options.chart, g = c.renderTo, f = e(d.width) && e(d.height),
                    k = d.width || a.getStyle(g, "width"), d = d.height || a.getStyle(g, "height"),
                    g = b ? b.target : M;
                ...
                e.getChartSize();
                b = f.globalAnimation;
                (b ? B : d)(e.container, {width: e.chartWidth + "px", height: e.chartHeight + "px"}, b);
                e.setChartSize(!0);
                ...
                var b = this.inverted, c = this.renderer, d = this.chartWidth, g = this.chartHeight,
                    e = this.options.chart, f = this.spacing, k = this.clipOffset, t, u, h, p;
                ...
                this.spacingBox = c.spacingBox = {x: f[3], y: f[0], width: d - f[3] - f[1], height: g - f[0] - f[2]};
                this.plotBox = c.plotBox = {x: t, y: u, width: h, height: p};
                ...
                var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                    ...
                    e = this.plotBackground, f = this.plotBorder, k, t = this.plotBGImage, n = a.backgroundColor,
                    u = a.plotBackgroundColor, h = a.plotBackgroundImage, p, q = this.plotLeft, E = this.plotTop,
                    m = this.plotWidth, l = this.plotHeight, w = this.plotBox, D = this.clipRect, y = this.clipBox,
                    z = "animate";
                ...
                g[z]({
                    x: p /
                    2, y: p / 2, width: c - p - k % 2, height: d - p - k % 2, r: a.borderRadius
                });
                z = "animate";
                e || (z = "attr", this.plotBackground = e = b.rect().addClass("highcharts-plot-background").add());
                e[z](w);
                e.attr({fill: u || "none"}).shadow(a.plotShadow);
                h && (t ? t.animate(w) : this.plotBGImage = b.image(h, q, E, m, l).add());
                D ? D.animate({width: y.width, height: y.height}) : this.clipRect = b.clipRect(y);
                z = "animate";
                f || (z = "attr", this.plotBorder = f = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                f.attr({
                    stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth ||
                    0, fill: "none"
                });
                f[z](f.crisp({x: q, y: E, width: m, height: l}, -f.strokeWidth()));
                this.isDirtyBox = !1
            }, propFromSeries: function () {
                var a = this, b = a.options.chart, c, d = a.options.series, g, e;
                ...
                c.items && n(c.items, function (d) {
                    var g = b(c.style, d.style), e = D(g.left) + a.plotLeft, f = D(g.top) + a.plotTop + 12;
                    delete g.left;
                    delete g.top;
                    a.renderer.text(d.html, e, f).attr({zIndex: 2}).css(g).add()
                })
            }, render: function () {
                var a =
                    this.axes, b = this.renderer, c = this.options, d, g, e;
                this.setTitle();
                ...
                var b = this, c = b.axes, d = b.series, g = b.container, e, f = g && g.parentNode;
                w(b, "destroy");
    ...
    (function (a) {
        var A, B = a.each, G = a.extend, F = a.erase, l = a.fireEvent,
            f = a.format, h = a.isArray, m = a.isNumber, r = a.pick, v = a.removeEvent;
        a.Point = A = function () {
        };
        a.Point.prototype = {
            init: function (a, e, f) {
                ...
                var d = {}, f = this.series,
                    b = f.options.keys, c = b || f.pointArrayMap || ["y"], l = c.length, k = 0, p = 0;
                if (m(a) || null === a) d[c[0]] = a; else if (h(a)) for (!b && a.length > l && (f = typeof a[0], "string" === f ? d.name = a[0] : "number" === f && (d.x = a[0]), k++); p < l;) b && void 0 === a[k] || (d[c[p]] = a[k]), k++, p++; else "object" === typeof a && (d = a, a.dataLabels && (f._hasPointLabels = !0), a.marker && (f._hasPointMarkers = !0));
                return d
                ...
                var a = this.series, e = a.zones, a = a.zoneAxis || "y", f = 0, b;
                ...
                var d = this.series, h = d.tooltipOptions, b = r(h.valueDecimals, ""), c = h.valuePrefix || "",
                    l = h.valueSuffix || "";
    ...
    (function (a) {
        var A = a.addEvent, B = a.animObject, G = a.arrayMax, F = a.arrayMin, l = a.correctFloat, f = a.Date,
            h = a.defaultOptions, m = a.defaultPlotOptions, r = a.defined, v = a.each, d = a.erase, e = a.extend,
            n = a.fireEvent, b = a.grep, c = a.isArray, w = a.isNumber, k = a.isString, p = a.merge, C = a.objectEach,
            I = a.pick, y = a.removeEvent, K = a.splat, q = a.SVGElement, z =
        ...
        a.Series = a.seriesType("line", null, {
            ...
            updateParallelArrays: function (a, b) {
                var c =
                    a.series, d = arguments, g = w(b) ? function (d) {
            ...
            setOptions: function (a) {
                var b = this.chart, c = b.options, d = c.plotOptions, g = (b.userOptions || {}).plotOptions || {},
                    e = d[this.type];
                this.userOptions = a;
                b = p(e, d.series, a);
                ...
                a.length && r(a[a.length - 1].value) && a.push({color: this.color, fillColor: this.fillColor});
                return b
            },
            getCyclic: function (a,
                                 b, c) {
                var d, g = this.chart, e = this.userOptions, f = a + "Index", k = a + "Counter",
            ...
            setData: function (b, d, e, f) {
                var g = this, t = g.points, h = t && t.length || 0, p, n = g.options, q = g.chart, l = null,
                    m = g.xAxis, y = n.turboThreshold, D = this.xData, E = this.yData,
                ...
                if (!1 !== f && p && h === p && !g.cropped && !g.hasGroupedData && g.visible) v(b, function (a, b) {
                    ...
                    if (y &&
                        ...
                        if (w(l)) for (e = 0; e < p; e++) D[e] = this.autoIncrement(), E[e] = b[e]; else if (c(l)) if (z) for (e = 0; e < p; e++) l = b[e], D[e] = l[0], E[e] = l.slice(1, z + 1); else for (e = 0; e < p; e++) l = b[e], D[e] = l[0], E[e] = l[1]; else a.error(12)
                    } else for (e = 0; e < p; e++) void 0 !== b[e] && (l = {series: g}, g.pointClass.prototype.applyOptions.apply(l, [b[e]]), g.updateParallelArrays(l, e));
            ...
            processData: function (b) {
                ...
                g = 0;
                var f, k, t = this.xAxis, h, p = this.options;
                h = p.cropThreshold;
                var n = this.getExtremesFromAll || p.getExtremesFromAll, q = this.isCartesian, p = t && t.val2lin,
                    l = t && t.isLog, m, w;
                if (q && !this.isDirty && !t.isDirty && !this.yAxis.isDirty && !b) return !1;
                t && (b = t.getExtremes(), m = b.min, w = b.max);
                if (q && this.sorted &&
                    !n && (!h || e > h || this.forceCrop)) if (c[e - 1] < m || c[0] > w) c = [], d = []; else if (c[0] < m || c[e - 1] > w) g = this.cropData(this.xData, this.yData, m, w), c = g.xData, d = g.yData, g = g.start, f = !0;
            ...
            cropData: function (a, b, c, d) {
                var e = a.length, f = 0, k = e, t = I(this.cropShoulder, 1), h;
                for (h = 0; h < e; h++) if (a[h] >= c) {
                    f = Math.max(0,
                        h - t);
                    break
                }
                for (c = h; c < e; c++) if (a[c] > d) {
                    k = c + t;
                    break
                }
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, c = this.data, d, e = this.processedXData, f = this.processedYData,
                    k = this.pointClass, h = e.length, p = this.cropStart || 0, n, q = this.hasGroupedData, a = a.keys,
                    l, m = [], w;
                ...
                this.options.keys = a;
                if (c && (h !== (d = c.length) || q)) for (w = 0; w < d; w++) w !== p || q || (w += h), c[w] && (c[w].destroyElements(), c[w].plotX = void 0);
                this.data = c;
                this.points = m
            },
            getExtremes: function (a) {
                var b = this.yAxis, d = this.processedXData, e, g = [], f = 0;
                e = this.xAxis.getExtremes();
                var k = e.min, t = e.max, h, p, n, q;
                a = a || this.stackedYData || this.processedYData || [];
                e = a.length;
                for (q = 0; q < e; q++) if (p = d[q], n = a[q], h = (w(n, !0) || c(n)) && (!b.positiveValuesOnly || n.length || 0 < n),
                        p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[q + 1] || p) >= k && (d[q - 1] || p) <= t, h && p) if (h = n.length) for (; h--;) null !== n[h] && (g[f++] = n[h]); else g[f++] = n;
                this.dataMin = F(g);
                this.dataMax = G(g)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points,
                    k = f.length, h = !!this.modifyValue, p = a.pointPlacement, n = "between" === p || w(p),
                    q = a.threshold, m = a.startFromThreshold ? q : 0, y, z, v,
                    K, J = Number.MAX_VALUE;
                "between" === p && (p = .5);
                w(p) && (p *= I(a.pointRange || c.pointRange));
                for (a = 0; a < k; a++) {
                    var C = f[a], A = C.x, B = C.y;
                    z = C.low;
                    var F = b && e.stacks[(this.negStacks && B < (m ? 0 : q) ? "-" : "") + this.stackKey], G;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, d = b.renderer, e = b.inverted, f = this.clipBox,
                    ...
                    h = b[t], p = b[t + "m"];
                h || (a && (k.width = 0, e && (k.x =
                    b.plotSizeX), b[t + "m"] = p = d.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[t] = h = d.clipRect(k), h.count = {length: 0});
            ...
            animate: function (a) {
                var b =
                    this.chart, c = B(this.options.animation), d;
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, c, d, e, f, k = this.options.marker, h, p, n, q,
                ...
                if (!1 !== k.enabled || this._hasPointMarkers) for (d = 0; d < a.length; d++) e = a[d], c = e.plotY, f = e.graphic, h = e.marker || {}, p = !!e.marker, n = m && void 0 === h.enabled || h.enabled, q = e.isInside, n && w(c) && null !== e.y ? (c = I(h.symbol, this.symbol), e.hasImage = 0 === c.indexOf("url"), n = this.markerAttribs(e, e.selected && "select"), f ? f[q ? "show" : "hide"](!0).animate(n) : q && (0 < n.width || e.hasImage) && (e.graphic = f = b.renderer.symbol(c, n.x, n.y, n.width, n.height, p ? h : k).add(l)), f && f.attr(this.pointAttribs(e, e.selected && "select")), f && f.addClass(e.getClassName(),
                    !0)) : f && (e.graphic = f.destroy())
            },
            markerAttribs: function (a, b) {
                var c = this.options.marker, d = a.marker || {}, e = I(d.radius, c.radius);
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, d = a && a.options, e = d && d.marker || {}, f = this.color,
                    k = d && d.color, t = a && a.color, d = I(e.lineWidth, c.lineWidth);
                ...
                return {stroke: f, "stroke-width": d, fill: a}
            },
            destroy: function () {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(J.navigator.userAgent), e, g, f = a.data || [],
                    k, h;
                n(a, "destroy");
                y(a);
                v(a.axisTypes || [], function (b) {
                    (h = a[b]) && h.series && (d(h.series, a), h.isDirty = h.forceRedraw =
                        !0)
                });
            ...
            getGraphPath: function (a, b, c) {
                var d = this, e = d.options, f = e.step, k, h = [], t = [], p;
                a = a || d.points;
                (k = a.reversed) && a.reverse();
                (f = {right: 1, center: 2}[f] || f && 3) && k && (f = 4 -
                    f);
                !e.connectNulls || b || c || (a = this.getValidPoints(a));
                v(a, function (g, k) {
                    var n = g.plotX, q = g.plotY, l = a[k - 1];
            ...
            drawGraph: function () {
                var a =
                        this, b = this.options, c = (this.gappedPath || this.getGraphPath).call(this),
                ...
                v(d, function (d, e) {
                    var g = d[0], f = a[g];
                    f ? (f.endX = c.xMap, f.animate({d: c})) : c.length && (a[g] = a.chart.renderer.path(c).addClass(d[1]).attr({zIndex: 1}).add(a.group), f = {
            ...
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, k = this.clips || [], h,
                    p = this.graph, n = this.area, q = Math.max(b.chartWidth, b.chartHeight),
                    l = this[(this.zoneAxis || "y") + "Axis"], m, w, y = b.inverted, z, r, K, C, J = !1;
                ...
                n && n.hide(), m = l.getExtremes(), v(d, function (d, g) {
                    ...
                    y && c.isVML && (h = l.isXAxis ? {x: 0, y: w ? K : C, height: h.width, width: b.chartWidth} : {
                        x: h.y - b.plotLeft - b.spacingBox.x,
                        y: 0, width: h.height, height: b.chartHeight
                    });
            ...
            plotGroup: function (a,
                                 b, c, d, e) {
                var g = this[a], f = !g;
                f && (this[a] = g = this.chart.renderer.g().attr({zIndex: d || .1}).add(e));
            ...
            render: function () {
                var a = this, b = a.chart, c, d = a.options,
                    ...
                    f = a.visible ? "inherit" : "hidden", k = d.zIndex, h = a.hasRendered, p = b.seriesGroup,
                    n = b.inverted;
                ...
                function a(c, d, e) {
                    ...
                    if (g = c && c.length) return f = b.kdAxisArray[d % e], c.sort(function (a, b) {
                        ...
                        point: c[g], left: a(c.slice(0,
                            g), d + 1, e), right: a(c.slice(g + 1), d + 1, e)
                    }
                }
            ...
            searchKDTree: function (a, b) {
                function c(a, b, g, h) {
                    var p = b.point, n = d.kdAxisArray[g % h], q, l, t = p;
                ...
                var d = this, e = this.kdAxisArray[0], f = this.kdAxisArray[1], k = b ? "distX" : "dist";
    ...
    (function (a) {
        var A = a.Axis, B = a.Chart, G = a.correctFloat, F = a.defined, l = a.destroyObjectProperties,
            f = a.each, h = a.format, m = a.objectEach, r = a.pick, v = a.Series;
        ...
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var d = this.options, f = d.format, f = f ? h(f, this) : d.formatter.call(this);
                ...
                var d = this.axis, b = d.chart, c = d.translate(d.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                ...
                var d = e.axis.reversed, p = a.inverted;
                a = a.plotHeight;
        ...
        A.prototype.buildStacks = function () {
            var a = this.series, e = r(this.options.reversedStacks, !0), f = a.length, b;
            if (!this.isXAxis) {
        ...
        A.prototype.renderStackTotals = function () {
            var a = this.chart, e = a.renderer, f = this.stacks, b = this.stackTotalGroup;
        ...
        v.prototype.setStackedPoints = function () {
            if (this.options.stacking &&
                ...
                var d = this.processedXData, e = this.processedYData, f = [], b = e.length, c = this.options,
                    h = c.threshold, k = c.startFromThreshold ? h : 0, p = c.stack, c = c.stacking, l = this.stackKey,
                    m = "-" + l, y = this.negStacks, v = this.yAxis, q = v.stacks, z = v.oldStacks, J, t, D, E, H, g, u;
                v.stacksTouched += 1;
        ...
        v.prototype.modifyStacks = function () {
            var a = this, e = a.stackKey, h = a.yAxis.stacks, b = a.processedXData, c, l = a.options.stacking;
            a[l + "Stacker"] && f([e, "-" + e], function (d) {
                for (var e = b.length, f, k; e--;) if (f = b[e], c = a.getStackIndicator(c, f, a.index, d), k = (f = h[d] && h[d][f]) && f.points[c.key]) a[l + "Stacker"](k, f, e)
            })
        };
        ...
        v.prototype.getStackIndicator =
            function (a, e, f, b) {
                !F(a) || a.x !== e || b && a.key !== b ? a = {x: e, index: 0, key: b} : a.index++;
                a.key = [f, e, a.index].join();
                return a
            }
    })(N);
    (function (a) {
        var A = a.addEvent, B = a.animate, G = a.Axis, F = a.createElement, l = a.css, f = a.defined, h = a.each,
            m = a.erase, r = a.extend, v = a.fireEvent, d = a.inArray, e = a.isNumber, n = a.isObject, b = a.isArray,
            c = a.merge, w = a.objectEach, k = a.pick, p = a.Point, C = a.Series, I = a.seriesTypes, y = a.setAnimation,
            K = a.splat;
        r(a.Chart.prototype, {
            addSeries: function (a, b, c) {
                var d, e = this;
                a && (b = k(b, !0), v(e, "addSeries", {options: a},
                    function () {
                        d = e.initSeries(a);
                        e.isDirtyLegend = !0;
                        e.linkSeries();
            ...
            addAxis: function (a, b, d, e) {
                ...
                a = c(a, {index: this[f].length, isX: b});
                b = new G(this, a);
                h[f] = K(h[f] || {});
                h[f].push(a);
                k(d, !0) && this.redraw(e);
            ...
            showLoading: function (a) {
                ...
                d || (b.loadingDiv = d = F("div", {className: "highcharts-loading highcharts-loading-hidden"},
                    null, b.container), b.loadingSpan = F("span", {className: "highcharts-loading-inner"}, null, d), A(b, "redraw", f));
                d.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || c.lang.loading;
                l(d, r(e.style, {zIndex: 10}));
                l(b.loadingSpan, e.labelStyle);
                b.loadingShown || (l(d, {
                    opacity: 0,
                    display: ""
                }), B(d, {opacity: e.style.opacity || .5}, {duration: e.showDuration || 0}));
                b.loadingShown = !0;
                f()
            },
            hideLoading: function () {
                var a = this.options, b = this.loadingDiv;
                b && (b.className = "highcharts-loading highcharts-loading-hidden", B(b, {opacity: 0},
                    {
            ...
            update: function (a, b, p) {
                var l = this, n = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, q = a.chart, m,
                    g, y = [];
                if (q) {
                    ...
                    "alignTicks" in q && (m = !0);
                    w(q, function (a, b) {
                        -1 !== d("chart." + b, l.propsRequireUpdateSeries) && (g = !0);
                        -1 !== d(b, l.propsRequireDirtyBox) && (l.isDirtyBox = !0)
                    });
                ...
                w(a, function (a, b) {
                    if (l[b] && "function" === typeof l[b].update) l[b].update(a, !1); else if ("function" === typeof l[n[b]]) l[n[b]](a);
                ...
                h("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
                    a[b] && (h(K(a[b]), function (a, c) {
                        ...
                        if (!c && p) if ("series" === b) l.addSeries(a, !1).touched = !0; else if ("xAxis" === b || "yAxis" === b) l.addAxis(a,
                            "xAxis" === b, !1).touched = !0
                    }), p && h(l[b], function (a) {
        ...
        r(p.prototype, {
            update: function (a, b, c, d) {
                ...
                var f = this, h = f.series, g = f.graphic, p, l = h.chart, q = h.options;
                b = k(b, !0);
        ...
        r(C.prototype, {
            addPoint: function (a, b, c, d) {
                var e = this.options, f = this.data, h = this.chart, g = this.xAxis, g = g && g.hasNames && g.names,
                    p = e.data, l, n, q = this.xData, m, t;
                b = k(b, !0);
                l = {series: this};
                this.pointClass.prototype.applyOptions.apply(l, [a]);
                t = l.x;
                m = q.length;
                if (this.requireSorting && t < q[m - 1]) for (n = !0; m && q[m - 1] > t;) m--;
                ...
                var d = this, e = d.data, f = e[a], h = d.points, g = d.chart, p = function () {
                ...
                var d = this, e = d.chart, f = d.userOptions, p = d.oldType || d.type,
                    l = a.type || f.type || e.options.chart.type, g = I[p].prototype, n,
                    q = ["group", "markerGroup", "dataLabelsGroup"], m = ["navigatorSeries", "baseSeries"],
                ...
                a = c(f, w, {index: d.index, pointStart: d.xData[0]}, {data: d.options.data}, a);
                d.remove(!1, null, !1);
    ...
    (function (a) {
        var A = a.color, B = a.each, G = a.map, F = a.pick, l = a.Series, f = a.seriesType;
        f("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (f) {
                var h = [], l = [], v = this.xAxis, d = this.yAxis, e = d.stacks[this.stackKey], n = {}, b = this.index,
                    c = d.series, w = c.length, k, p = F(d.options.reversedStacks, !0) ? 1 : -1, C;
                f = f || this.points;
                if (this.options.stacking) {
                    ...
                    B(l, function (a, c) {
                        ...
                        if (n[a] && !n[a].isNull) h.push(n[a]), B([-1, 1], function (d) {
                            var f = 1 === d ? "rightNull" : "leftNull", h = 0, q = e[l[c + d]];
                            if (q) for (C = b; 0 <= C && C < w;) m = q.points[C], m || (C === b ? n[a][f] = !0 : k[C] && (y = e[a].points[C]) && (h -= y[1] - y[0])), C += p;
                ...
                var f = l.prototype.getGraphPath, h = this.options, v = h.stacking, d = this.yAxis, e, n, b = [],
                    c = [], w = this.index, k, p = d.stacks[this.stackKey], C = h.threshold,
                    I = d.getThreshold(h.threshold), y, h = h.connectNulls || "percent" === v, K = function (e, f, h) {
                        var l = a[e];
                        e = v && p[l.x].points[w];
                        var n = l[h + "Null"] || 0;
                        h = l[h + "Cliff"] || 0;
                        ...
                        void 0 !== m && (c.push({
                            plotX: k, plotY: null === m ? I : d.getThreshold(m),
                            isNull: l, isCliff: !0
                        }), b.push({plotX: k, plotY: null === q ? I : d.getThreshold(q), doCurve: !1}))
                    };
                a = a || this.points;
                v && (a = this.getStackPoints(a));
                for (e = 0; e < a.length; e++) if (n = a[e].isNull, k = F(a[e].rectPlotX, a[e].plotX), y = F(a[e].yBottom, I), !n || h) h || K(e, e - 1, "left"), n && !v && h || (c.push(a[e]), b.push({
                    x: e,
                    plotX: k,
                    plotY: y
                })), h || K(e, e + 1, "right");
                ...
                var a = this, f = this.areaPath, r = this.options,
                    v = [["area", "highcharts-area", this.color, r.fillColor]];
                ...
                B(v, function (d) {
                    var e = d[0], h = a[e];
                    h ? (h.endX = f.xMap, h.animate({d: f})) : (h = a[e] = a.chart.renderer.path(f).addClass(d[1]).attr({
                        fill: F(d[3], A(d[2]).setOpacity(F(r.fillOpacity, .75)).get()),
                        zIndex: 0
                    }).add(a.group), h.isArea =
                        !0);
                    h.startX = f.xMap;
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a, G, F) {
                var l = G.plotX, f = G.plotY, h = a[F - 1];
                F = a[F + 1];
                var m, r, v, d;
    ...
    (function (a) {
        var A = a.animObject, B = a.color, G = a.each, F = a.extend, l = a.isNumber, f = a.merge, h = a.pick,
            m = a.Series, r = a.seriesType, v = a.svg;
        r("column", "line", {
            borderRadius: 0,
            crisp: !0,
            groupPadding: .2,
            ...
            getColumnMetrics: function () {
                var a = this, e = a.options, f = a.xAxis, b = a.yAxis, c = f.reversed, l, k = {}, p = 0;
                !1 === e.grouping ? p = 1 : G(a.chart.series, function (c) {
                    var d = c.options, e = c.yAxis, f;
                ...
                var m = Math.min(Math.abs(f.transA) * (f.ordinalSlope || e.pointRange || f.closestPointRange || f.tickInterval || 1), f.len),
                    r = m * e.groupPadding, y = (m - 2 * r) / (p || 1),
            ...
            crispCol: function (a, e, f, b) {
                var c =
                    this.chart, d = this.borderWidth, k = -(d % 2 ? .5 : 0), d = d % 2 ? .5 : 1;
                ...
                b -= e;
                k && b && (--e, b += 1);
                return {x: a, y: e, width: f, height: b}
            },
            translate: function () {
                var a = this, e = a.chart, f = a.options, b = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
                    b = a.borderWidth = h(f.borderWidth, b ? 0 : 1), c = a.yAxis,
                    l = a.translatedThreshold = c.getThreshold(f.threshold), k = h(f.minPointLength, 5),
                    p = a.getColumnMetrics(), r = p.width, v = a.barW = Math.max(r, 1 + 2 * b),
                    y = a.pointXOffset = p.offset;
                e.inverted && (l -= .5);
                f.pointPadding && (v = Math.ceil(v));
                m.prototype.translate.apply(a);
                G(a.points, function (b) {
                    var d = h(b.yBottom, l), f = 999 + Math.abs(d), f = Math.min(Math.max(-f, b.plotY), c.len + f),
                        p = b.plotX + y, m = v, n = Math.min(f, d), w, C = Math.max(f, d) - n;
                    k && Math.abs(C) < k && (C = k, w = !c.reversed && !b.negative || c.reversed && b.negative, 0 === b.y && 0 >= a.dataMax && (w = !w), n = Math.abs(n - l) > k ? d - k : l - (w ? k : 0));
                    b.barX = p;
                    b.pointWidth = r;
                    b.tooltipPos = e.inverted ?
                        [c.len + c.pos - e.plotLeft - f, a.xAxis.len - p - m / 2, C] : [p + m / 2, f + c.pos - e.plotTop, C];
                    b.shapeType = "rect";
            ...
            pointAttribs: function (a, e) {
                var d = this.options, b, c = this.pointAttrToOptions || {};
                b = c.stroke || "borderColor";
                var h = c["stroke-width"] || "borderWidth", k = a && a.color || this.color, p = a && a[b] || d[b] ||
                    this.color || k, l = a && a[h] || d[h] || this[h] || 0, c = d.dashStyle;
                ...
                b = {fill: k, stroke: p, "stroke-width": l};
                c && (b.dashstyle = c);
                return b
            },
            drawPoints: function () {
                var a = this, e = this.chart, h = a.options, b = e.renderer, c = h.animationLimit || 250, m;
                G(a.points, function (d) {
                    var k =
                        d.graphic;
                    if (l(d.plotY) && null !== d.y) {
                        m = d.shapeArgs;
                        if (k) k[e.pointCount < c ? "animate" : "attr"](f(m)); else d.graphic = k = b[d.shapeType](m).add(d.group || a.group);
                        h.borderRadius && k.attr({r: h.borderRadius});
            ...
            animate: function (a) {
                var d = this, f = this.yAxis, b = d.options, c = this.chart.inverted, h = {},
                    k = c ? "translateX" : "translateY", p;
                v && (a ? (h.scaleY = .001, a = Math.min(f.pos +
                    f.len, Math.max(f.pos, f.toPixels(b.threshold))), c ? h.translateX = a - f.len : h.translateY = a, d.group.attr(h)) : (p = d.group.attr(k), d.group.animate({scaleY: 1}, F(A(d.options.animation), {
                    step: function (a, b) {
                        h[k] = p + b.pos * (f.pos - p);
                        d.group.attr(h)
                    }
    ...
    (function (a) {
        var A = a.deg2rad, B = a.isNumber, G = a.pick, F = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, f = this.chart, h = 2 * (a.slicedOffset || 0), m = f.plotWidth - 2 * h,
                    f = f.plotHeight - 2 * h, r = a.center,
                    r = [G(r[0], "50%"), G(r[1], "50%"), a.size || "100%", a.innerSize || 0], v = Math.min(m, f), d, e;
                ...
                return {start: A * (a + -90), end: A * (f + -90)}
            }
        }
    })(N);
    (function (a) {
        var A = a.addEvent, B = a.CenteredSeriesMixin, G = a.defined, F = a.each, l = a.extend,
            f = B.getStartAndEndRadians, h = a.inArray, m = a.noop, r = a.pick, v = a.Point, d = a.Series,
            e = a.seriesType, n = a.setAnimation;
        e("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            updateTotals: function () {
                var a, c = 0, d = this.points, e = d.length, f, h = this.options.ignoreHiddenPoint;
            ...
            translate: function (a) {
                this.generatePoints();
                var b = 0, d = this.options, e = d.slicedOffset, h = e + (d.borderWidth || 0),
                    l, m, n, v = f(d.startAngle, d.endAngle), q = this.startAngleRad = v.start,
                    v = (this.endAngleRad = v.end) - q, z = this.points, J, t = d.dataLabels.distance,
                    d = d.ignoreHiddenPoint, D, E = z.length, H;
            ...
            drawGraph: null,
            drawPoints: function () {
                var a = this, c = a.chart.renderer, d, e, f, h, m = a.options.shadow;
                m && !a.shadowGroup && (a.shadowGroup = c.g("shadow").add(a.group));
                F(a.points, function (b) {
                    e = b.graphic;
                    if (b.isNull) e && (b.graphic = e.destroy()); else {
                        h = b.shapeArgs;
                        d = b.getTranslate();
                        var k = b.shadowGroup;
                        m && !k && (k = b.shadowGroup =
                        ...
                        e ? e.setRadialReference(a.center).attr(f).animate(l(h, d)) : (b.graphic = e = c[b.shapeType](h).setRadialReference(a.center).attr(d).add(a.group), b.visible || e.attr({visibility: "hidden"}), e.attr(f).attr({"stroke-linejoin": "round"}).shadow(m, k));
            ...
            init: function () {
                ...
                var b = this, d = b.series, e = d.chart, f = d.options.ignoreHiddenPoint;
                c = r(c, f);
    ...
    (function (a) {
        var A = a.addEvent, B = a.arrayMax, G = a.defined, F = a.each, l = a.extend, f = a.format, h = a.map,
            m = a.merge, r = a.noop, v = a.pick, d = a.relativeLength, e = a.Series, n = a.seriesTypes,
            b = a.stableSort;
        ...
        e.prototype.drawDataLabels = function () {
            var b = this, d = b.options, e = d.dataLabels, h = b.points, l, n, y = b.hasRendered || 0, r, q,
                z = v(e.defer, !!d.animation), J = b.chart.renderer;
            ...
            z && (q.attr({opacity: +y}), y || A(b, "afterAnimate", function () {
                b.visible && q.show(!0);
                q[d.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), n = e, F(h, function (c) {
                var k, h = c.dataLabel, p, g, t = c.connector, y = !h, w;
        ...
        e.prototype.alignDataLabel = function (a, b, d, e, f) {
            var c = this.chart, k = c.inverted, h = v(a.plotX, -9999), m = v(a.plotY, -9999), p = b.getBBox(), n,
                t = d.rotation, w = d.align,
            ...
            if (r && (n = d.style.fontSize, n = c.renderer.fontMetrics(n, b).b, e = l({
                ...
                }, b[f ? "attr" : "animate"](h).attr({align: w}), m = (t + 720) % 360, m = 180 < m && 360 > m, "left" === w ? h.y -= m ? p.height : 0 : "center" === w ? (h.x -= p.width / 2, h.y -= p.height / 2) : "right" === w && (h.x -= p.width, h.y -=
            ...
            r || (b.attr({y: -9999}), b.placed = !1)
        };
        e.prototype.justifyDataLabel = function (a, b, d, e, f, h) {
            var c = this.chart, k = b.align, l = b.verticalAlign, m, p, n = a.box ? 0 : a.padding || 0;
            m = d.x + n;
        ...
        n.pie && (n.pie.prototype.drawDataLabels = function () {
            var b = this, d = b.data, f, h = b.chart, l = b.options.dataLabels, m = v(l.connectorPadding, 10),
                n = v(l.connectorWidth, 1), r = h.plotWidth, q = h.plotHeight, z, A = b.center, t = A[2] /
                2, D = A[1], E, H, g, u, P = [[], []], M, O, L, N, x = [0, 0, 0, 0];
            b.visible && (l.enabled || b._hasPointLabels) && (F(d, function (a) {
                ...
                var e, k, p = c.length, n = [], y;
                if (p) for (b.sortByAngle(c, d - .5), 0 < b.maxLabelDistance && (e = Math.max(0, D - t - b.maxLabelDistance),
            ...
            (this.placeDataLabels(), n && F(this.points, function (a) {
                ...
                if ((E = a.dataLabel) && E._pos && a.visible && 0 < a.labelDistance) {
                    ...
                    z[c ? "attr" : "animate"]({d: b.connectorPath(a.labelPos)});
                    z.attr("visibility", L)
            ...
            var b = this.center, c = this.options, e = c.center, f = c.minSize || 80, h, l = null !== c.size;
        ...
        n.column && (n.column.prototype.alignDataLabel = function (a, b, d, f, h) {
            var c = this.chart.inverted, k = a.series, l = a.dlBox || a.shapeArgs,
    ...
    (function (a) {
        var A = a.Chart, B = a.each, G = a.objectEach, F = a.pick, l = a.addEvent;
        A.prototype.callbacks.push(function (a) {
            l(a, "render", function () {
                ...
                B(a.series || [], function (a) {
                    var h = a.options.dataLabels, l = a.dataLabelCollections || ["dataLabel"];
        ...
        A.prototype.hideOverlappingLabels = function (a) {
            var f =
                a.length, l, r, v, d, e, n, b, c, w, k = function (a, b, c, d, e, f, h, k) {
                return !(e > a + c || e + h < a || f > b + d || f + k < b)
            };
            for (r = 0; r < f; r++) if (l = a[r]) l.oldOpacity = l.opacity, l.newOpacity = 1, l.width || (v = l.getBBox(), l.width = v.width, l.height = v.height);
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (r = 0; r < f; r++) for (v = a[r], l = r + 1; l < f; ++l) if (d = a[l], v && d && v !== d && v.placed && d.placed && 0 !== v.newOpacity && 0 !== d.newOpacity && (e = v.alignAttr, n = d.alignAttr, b = v.parentGroup, c = d.parentGroup, w = 2 * (v.box ? 0 : v.padding || 0), e = k(e.x + b.translateX,
    ...
    (function (a) {
        var A = a.addEvent, B = a.Chart, G = a.createElement, F = a.css, l = a.defaultOptions, f = a.defaultPlotOptions,
            h = a.each, m = a.extend, r = a.fireEvent, v = a.hasTouch, d = a.inArray,
            e = a.isObject, n = a.Legend, b = a.merge, c = a.pick, w = a.Point, k = a.Series, p = a.seriesTypes,
            C = a.svg, I;
        I = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                    e = d.length, f = a.chart, k = f.pointer, l = f.renderer, n = f.options.tooltip.snap, g = a.tracker,
                    m, p = function () {
                        if (f.hoverSeries !== a) a.onMouseOver()
                    }, r = "rgba(192,192,192," + (C ? .0001 : .002) + ")";
                if (e && !c) for (m = e + 1; m--;) "M" === d[m] && d.splice(m + 1, 0, d[m +
                1] - n, d[m + 2], "L"), (m && "M" === d[m] || m === e) && d.splice(m, 0, "L", d[m - 2] + n, d[m - 1]);
                g ? g.attr({d: d}) : a.graph && (a.tracker = l.path(d).attr({
                    "stroke-linejoin": "round",
        ...
        m(n.prototype, {
            setItemEvents: function (a, c, d) {
                ...
                A(a.checkbox, "click", function (b) {
                    r(a.series || a, "checkboxClick", {checked: b.target.checked, item: a}, function () {
                        a.select()
                    })
                })
            }
        ...
        m(B.prototype, {
            showResetZoom: function () {
                var a = this, b = l.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states,
                ...
                h("xy" === b ? [1, 0] :
                    ...
                    var d = b.horiz, f = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", h = c[d],
                        ...
                        g = b.toValue(h + b.len - f, !0) - g, m = g < l, h = m ? g : l, l = m ? l : g,
                        g = Math.min(k.dataMin, b.toValue(b.toPixels(k.min) - b.minPixelPadding)),
                        m = Math.max(k.dataMax, b.toValue(b.toPixels(k.max) + b.minPixelPadding)), n;
                    n = g - h;
                    0 < n && (l += n, h = g);
                    n = l - m;
                    0 < n && (l = m, h -= n);
        ...
        m(w.prototype, {
            select: function (a, b) {
                ...
                if (!this.hasImportedEvents) {
                    var c = this, d = b(c.series.options.point, c.options).events;
                    c.events = d;
                ...
                var d = Math.floor(this.plotX),
                    e = this.plotY, h = this.series, k = h.options.states[a] || {},
                    l = f[h.type].marker && h.options.marker, n = l && !1 === l.enabled,
                    p = l && l.states && l.states[a] || {}, g = !1 === p.enabled, r = h.stateMarkerGraphic,
                    v = this.marker || {}, w = h.chart, y = h.halo, A, B = l && h.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (g || n && !1 === p.enabled) || a && v.states && v.states[a] && !1 === v.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" +
                        this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(h.pointAttribs(this, a), c(w.options.chart.animation, k.animation)), A && this.graphic.animate(A, c(w.options.chart.animation, p.animation, l.animation)), r && r.hide(); else {
                        if (a && p) {
                            l = v.symbol || h.symbol;
                    ...
                    (d = k.halo) && d.size ? (y || (h.halo = y = w.renderer.path().add((this.graphic || r).parentGroup)), y[b ? "animate" : "attr"]({d: this.haloPath(d.size)}), y.attr({"class": "highcharts-halo highcharts-color-" + c(this.colorIndex, h.colorIndex)}), y.point = this, y.attr(m({
                        fill: this.color || h.color,
                        "fill-opacity": d.opacity,
                        zIndex: -1
                    }, d.attributes))) : y && y.point && y.point.haloPath && y.animate({d: y.point.haloPath(0)});
                    this.state = a
                }
            }, haloPath: function (a) {
        ...
        m(k.prototype, {
            onMouseOver: function () {
                ...
                var b = this,
                    d = b.options, e = b.graph, f = d.states, k = d.lineWidth, d = 0;
                a = a || "";
                if (b.state !== a && (h([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
                        c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                    }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (k = f[a].lineWidth || k + (f[a].lineWidthPlus || 0)), e && !e.dashstyle)) for (k = {"stroke-width": k}, e.animate(k, c(b.chart.options.chart.animation, f[a] && f[a].animation)); b["zone-graph-" + d];) b["zone-graph-" + d].attr(k), d += 1
            }, setVisible: function (a,
                                     b) {
                var c = this, d = c.chart, e = c.legendItem, f, k = d.options.chart.ignoreHiddenSeries, l = c.visible;
    ...
    (function (a) {
        var A = a.Chart, B = a.each, G = a.inArray, F = a.isArray, l = a.isObject, f = a.pick, h = a.splat;
        A.prototype.setResponsive = function (f) {
            var h = this.options.responsive, l = [], d = this.currentResponsive;
            h && h.rules &&
        ...
        A.prototype.currentOptions = function (f) {
            function m(d, e, f, b) {
                ...
                a.objectEach(d, function (a, k) {
                    if (!b && -1 < G(k, ["series", "xAxis", "yAxis"])) for (d[k] = h(d[k]), f[k] = [], c = 0; c < d[k].length; c++) e[k][c] && (f[k][c] = {}, m(a[c], e[k][c], f[k][c], b + 1)); else l(a) ? (f[k] = F(a) ? [] : {}, m(a, e[k] || {}, f[k], b + 1)) : f[k] =
                        e[k] || null
                })
            }
